    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PacoteCidadeDestino", x => new { x.CidadesDestinoId, x.PacotesTuristicosId });
                    table.ForeignKey(
                        name: "FK_PacoteCidadeDestino_CidadesDestino_CidadesDestinoId",
                        column: x => x.CidadesDestinoId,
                        principalTable: "CidadesDestino",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PacoteCidadeDestino_PacotesTuristicos_PacotesTuristicosId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PacoteCidadeDestino_PacotesTuristicosId",
